/*
    ...
    File Description: MyLinkedList from the textbook with 2 additional methods.
*/
...
public class MyLinkedListTest<E> implements MyList<E> {
  ...
  public MyLinkedListTest(E[] objects) {
  ...
  // <-- Changed: Add a new element to the end of the list -->
  @Override 
  ...
  // <-- Changed: Remove the first occurrence of the specified element -->
  @Override 
